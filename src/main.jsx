...
console.log("Hi if you notice a bug please contact me ashish.jayshreeram@gmail.com")
...
root.render(
  ...
  <section aria-hidden="true">
    <h1>Ashish Singh - Creative Developer</h1>
    <h2>Computer Science Student at Bordeaux University</h2>
    <h2>Three.js and React Three Fiber Learner</h2>
    <h2>learning 3D Web Development</h2>
  </section>
  <section aria-hidden="true">
    <h2>Skills and Expertise</h2>
    <ul>
      <li>Html/CSS Developer</li>
      <li>React Three Fiber Learning</li>
      <li>GSAP Developer</li>
      <li>3D Web Beginner</li>
      <li>Creative Coding</li>
    </ul>
  </section>
  <section aria-hidden="true">
    <p>
      Welcome to the 3D portfolio of Ashish Singh. This immersive portfolio has 
  ...
  <noscript>
    <p>
      This 3D portfolio of Ashish Singh showcases creative web development using 
