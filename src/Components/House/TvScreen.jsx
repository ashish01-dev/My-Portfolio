...
export default function TvScreen(props)
{
    ...
    <group ref={logosRef}>
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://github.com/ashish01-dev")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://x.com/TechMaster54321")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]} 
        onClick={() => handleClick("https://www.linkedin.com/in/ashish-kumar-singh-9002a437a/")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.07, 0.1, 0.1]}
        onClick={() => handleClick("./CV/CVashish.pdf")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        scale={[0.09, 0.1, 0.1]}
        onClick={() => handleClick("https://github.com/ashish01-dev/My-Portfolio")}
      >
        <planeGeometry/>
      ...
      <mesh 
        ...
        onClick={() => handleClick("mailto:ashish.jayshreeram@gmail.com")}
      >
        <planeGeometry/>
